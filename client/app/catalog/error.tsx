...
export default function CatalogError({ error, reset }: CatalogErrorProps) {
  return (
    <main className="w-full flex flex-col items-center gap-4 px-5 py-[120px] md:px-10 md:py-[160px]">
      <h1 className="font-serif text-4xl font-medium text-foreground">Не удалось загрузить каталог</h1>
      ...
      <div className="w-full max-w-[320px] flex flex-col gap-3">
        ...
        >
          <span className="typo-not-found-cta font-sans font-semibold text-foreground">На главную</span>
        </Link>
      </div>
    </main>
  );
